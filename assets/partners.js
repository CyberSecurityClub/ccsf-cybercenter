...
partnersDiv.innerHTML = `
  ...
  <div class="container hide-on-small-only">
    ...
    <div class="row partner-row">
      ...
      <div class="col s2">
        <a href="https://www.vmware.com/" target="blank">
          <img src="img/vmware-logo.png" class="responsive-img partner-img" alt="">
        </a>
      </div>
      <div class="col s2">
        <a href="https://www.dellemc.com/en-us/index.htm" target="blank">
          <img src="img/dell-emc-logo.png" class="responsive-img partner-img" alt="">
        </a>
      </div>
      <div class="col s2">
        <a href="https://azure.microsoft.com/en-us/" target="blank">
          <img src="img/azure-logo.png" class="responsive-img partner-img" alt="">
        </a>
      </div>
      <div class="col s2">
        <a href="https://www.splunk.com/" target="blank">
          <img src="img/splunk-logo.png" class="responsive-img partner-img" alt="">
        </a>
      </div>
    </div>
